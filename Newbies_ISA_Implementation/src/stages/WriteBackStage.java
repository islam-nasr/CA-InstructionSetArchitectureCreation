...
public class WriteBackStage extends Stage {
	...
	public void execute() {
		...
		String w1 = MUXsim.MUX(integerConverter.toBinaryString(readData1), integerConverter.toBinaryString(readData2),
				control.getMin());
		String w2 = MUXsim.MUX(integerConverter.toBinaryString(readData1), integerConverter.toBinaryString(readData2),
				control.getMax());
		...
		String out1 = MUXsim.MUX(result, integerConverter.toBinaryString(readData), control.getMemToReg());
		...
		if (!(writeRegisterNumber == 0 || writeRegisterNumber == 1 || writeRegisterNumber == 3))
